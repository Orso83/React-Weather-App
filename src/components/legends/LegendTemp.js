...
const LegendTemp = (props) => {
  ...
  const metric = [-40, -30, -20, -10, 0, 10, 20, 30, 40];
  const imperial = [-40, -22, -4, 14, 32, 50, 68, 86, 104];
  ...
  **********************************************************/
  ...
  return (
    <div className={classes.main}>
      <Typography className={classes.title} variant="body1">Temperature: &deg;{units ? 'C' : 'F'}</Typography>
